...
<jsp:include page="common/nav.jsp" />
	...
	function goToUserlogout(userId) {
	    // PK 값을 사용하여 URL 생성
	    var url = 'logOut?user_id=' + userId;
	
	    // 생성된 URL로 페이지 이동
	    window.location.href = url;
	  }
	</script>
  <button id="logOut" type="button" onclick="goToUserlogout(${user_id})" class="btn btn-outline-primary" style="float: right;">로그 아웃</button>
...
<button id="writebutton" type="button" class="btn btn-secondary btn-sm" onclick="location.href='write'" style="float: left;">글쓰기</button>
